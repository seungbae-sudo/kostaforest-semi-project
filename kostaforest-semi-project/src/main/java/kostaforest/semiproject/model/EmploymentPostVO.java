...
public class EmploymentPostVO{
	...
	public EmploymentPostVO(int boardNo, String title, String content, String timePosted, int likeNo, int hits,
	...
	public String toString() {
		return "EmploymentPostVO [boardNo=" + boardNo + ", title=" + title + ", content=" + content + ", timePosted="
